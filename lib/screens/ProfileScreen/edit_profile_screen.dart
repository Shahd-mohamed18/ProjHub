...
class _EditProfileScreenState extends State<EditProfileScreen> {
 ...
 Future<void> _handleSave() async {
  ...
  if (selectedImagePath != widget.currentImage) {
    if (selectedImagePath.startsWith('/data/') || 
        selectedImagePath.startsWith('/storage/')) {
      photoUrlToSend = selectedImagePath; // سيتم رفعه كملف
    } else {
      photoUrlToSend = selectedImagePath; // رابط موجود مسبقاً
    }
  }
