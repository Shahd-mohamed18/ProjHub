...
// widgets/Profile/image_picker_widget.dart
import 'dart:io';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
...
class _ImagePickerWidgetState extends State<ImagePickerWidget> {
    ...
    return GestureDetector(
      ...
      child: Stack(
        ...
        children: [
          ...
          CircleAvatar(
            radius: widget.cameraIconSize + 4,
            backgroundColor: widget.backgroundColor,
            child: CircleAvatar(
              radius: widget.cameraIconSize,
              backgroundColor: Colors.white,
              child: Icon(
                Icons.camera_alt,
                size: widget.cameraIconSize - 4,
                color: widget.iconColor,
              ),
            ),
          ),
  ...
  Widget _buildAvatarContent() {
    ...
    // التحقق مما إذا كان المسار رابطًا شبكيًا
    final bool isNetwork = _imagePath!.startsWith('http://') || _imagePath!.startsWith('https://');
